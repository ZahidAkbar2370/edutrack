...
<form action="{{ URL::to('student/update/' . $student->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
            ...
            <div class="card h-100 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <div class="mt-2">
                            <img id="student_photo_preview" src="{{ old('student_photo') ? old('student_photo') : ($student->student_photo ? asset($student->student_photo) : asset('Admin/images/student/profiles/default.png')) }}" alt="Preview" class="rounded border" style="width:120px;height:120px;object-fit:cover;">
                        </div>
                    </div>
